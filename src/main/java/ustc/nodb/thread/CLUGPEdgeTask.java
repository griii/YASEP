...
public class CLUGPEdgeTask implements Callable<CLUGPEdge>
{
    ...
    private int taskId;
    private PartitionResBuffer partitionResBuffer;
    
    public CLUGPEdgeTask(final EdgeStreamCluster edgeStreamCluster, final BatchFileIO batchFileIO, final int taskId, final PartitionResBuffer partitionResBuffer) {
        ...
        this.cluster.addAll((Collection<? extends Integer>) edgeStreamCluster.getClusterList().subList(begin, end));
        this.partitionResBuffer = partitionResBuffer;
    }
    ...
    public CLUGPEdge call() throws Exception {
        ...
        clugpEdge.performStep(partitionResBuffer);
        partitionResBuffer.flush();
        return clugpEdge;
    }
}
