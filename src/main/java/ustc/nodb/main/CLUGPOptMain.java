...
public class CLUGPOptMain
{
    public static void main(final String[] args) throws IOException {
        if (args.length < 9) {
            System.out.println("Usage: [vCount] [eCount] [input_path] [threads]" +
                    " [partition_number] [batch_size] [output_path] [tau] [batchEdgePath]");
        }
        GlobalConfig.vCount = 1134890;
        GlobalConfig.eCount = 2987624;
//        GlobalConfig.eCount = 11;
        GlobalConfig.inputGraphPath = "D:\\360MoveData\\Users\\GuoRii\\Desktop\\论文阅读\\CLUGP\\com-youtube.ungraph.txt";
//        GlobalConfig.inputGraphPath = "D:\\360MoveData\\Users\\GuoRii\\Desktop\\论文阅读\\CLUGP\\test.txt";
        GlobalConfig.threads = 32;
        GlobalConfig.partitionNum = 8;
        GlobalConfig.clusterNumber = 128;
        GlobalConfig.batchSize = 10240;
        GlobalConfig.outputGraphPath = "D:\\360MoveData\\Users\\GuoRii\\Desktop\\论文阅读\\CLUGP\\output.txt";
        GlobalConfig.tau = 1;
        GlobalConfig.batchEdgePath = "D:\\360MoveData\\Users\\GuoRii\\Desktop\\论文阅读\\CLUGP\\com-youtube.batch.txt";
        GlobalConfig.batchEdgePath = "D:\\360MoveData\\Users\\GuoRii\\Desktop\\论文阅读\\CLUGP\\test.batch";
...
//        GlobalConfig.tautau = Double.parseDouble(args[7]);
//        GlobalConfig.batchEdgePath = args[8];
        ...
        PartitionResBuffer partitionResBuffer = new PartitionResBuffer(GlobalConfig.outputGraphPath);
        ...
        for (int i = 0; i < taskNum; ++i) {
            completionService.submit((Callable<CLUGPEdge>)new CLUGPEdgeTask(edgeStreamCluster, batchFileIO, i,partitionResBuffer));
        }
        for (int i = 0; i < taskNum; ++i) {
            try {
